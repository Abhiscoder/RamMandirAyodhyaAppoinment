...
const TopServices = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      <h1 className='text-3xl font-medium'>Top Guides to Book</h1>
      <p className='sm:w-1/3 text-center text-sm'>
        Simply browse through our extensive list of trusted guides and services for your Ram Mandir visit.
      </p>
      ...
      <button
        ...
        className='bg-orange-300 text-gray-600 px-12 py-3 rounded-full mt-10'
      >
        more
      </button>
    </div>
